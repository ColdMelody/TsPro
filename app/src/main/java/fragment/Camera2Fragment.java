...
public class Camera2Fragment extends Fragment implements View.OnClickListener {
    ...
    // 等待曝光变为其他状态
    private static final int STATE_WAITING_NO_PRECAPTURE = 3;
    // 照片已经拍摄
                    ...
                    switch (mState) {
                        ...
                        case STATE_WAITING_PRECAPTURE: {
                            ...
                            if (aeState == null ||
                                ...
                                mState = STATE_WAITING_NO_PRECAPTURE;
                            }
                            break;
                        }
                        case STATE_WAITING_NO_PRECAPTURE: {
                            Integer aeState = result.get(CaptureResult.CONTROL_AE_STATE);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mTextureView = (AutoTextureView) view.findViewById(R.id.texture);
    }
